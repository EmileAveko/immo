...
import 'package:immoproject/navigation.dart';

class StaggerAnimation extends StatelessWidget {
   String cle;
  StaggerAnimation({Key key, this.buttonController,this.cle})
  ...
  Widget build(BuildContext context) {
    buttonController.addListener(() {
      if (buttonController.isCompleted) {
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => Navigation(this.cle)),(_)=>false);
        print(this.cle);
      }
    });
